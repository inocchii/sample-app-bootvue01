...
var BlueJelly = function(){
  ...
  //callBack
  this.onScan = function(deviceName){console.log("onScan deviceName:"+deviceName);};
  this.onConnectGATT = function(uuid){console.log("onConnectGATT uuid:"+uuid);};
  this.onRead = function(data, uuid){console.log("onRead data:"+data+" uuid:"+uuid);};
  this.onWrite = function(uuid){console.log("onWrite uuid:"+uuid);};
  this.onStartNotify = function(uuid){console.log("onStartNotify uuid:"+uuid);};
  this.onStopNotify = function(uuid){console.log("onStopNotify uuid:"+uuid);};
  ...
  this.onError = function(error){console.log("onError error:"+error);};
}
...
BlueJelly.prototype.disconnect= function() {
  ...
  if (this.bluetoothDevice.gatt.connected) {
   ...
   error = "Bluetooth Device is already disconnected";
   console.log('Error : ' + error);
   this.onError(error);
   return;
  }
